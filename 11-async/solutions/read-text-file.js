/**
 * Simulates a reading action to a specific file.
 * @param {string} filename - The file name.
 * @returns {string}
 */
export function textFile(filename) {
    const read_tf = readTextFile();
    return new Promise((resolve, reject) => {
        read_tf(filename, (text, error) => {
...
/**
 * Simulates a file reading by creating a string representing some specific files.
 * @returns 
 */
